              ...
              {funnelSteps.map((step) => (
                <div key={step.key} className="text-center">
                  ...
                  <div className={`w-full h-16 rounded-xl border-4 flex items-center justify-center transition-all ${
                    // SỬ DỤNG MÀU XANH/XÁM CƠ BẢN THAY VÌ step.color
                    candidate[step.key as keyof Candidate]
                      ? 'bg-indigo-100 border-indigo-600 shadow-lg scale-105' // Màu khi được chọn (màu xanh Indigo)
                      : 'bg-gray-50 border-gray-300' // Màu khi chưa chọn
                  }`}>
                    <input
                      type="checkbox"
                ...
                {candidate.reject_offer && (
                  <div>
                    ...
                    <textarea
                      ...
                      className="mt-2 w-full px-4 py-3 border border-red-300 rounded-lg text-lg"
                      rows={3}
