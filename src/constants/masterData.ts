...
export const MASTER_DATA: MasterDataType = {
  ...
  projectCompanyMap: {
    ...
    "Canon Tuyển dụng": "Canon - Hưng Yên",
        "CCTY Tuyển dụng": "CCTY - Hải Phòng",
  ...
  sourceTypesByGroup: {
    ...
    "MKT Organic khác": ["Hotline", "Zalo OA", "Website", "Group Zalo", "Group Facebook", "Fanpage Facebook","Khai thác lại","Social khác","LadiPage"],
